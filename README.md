...
- `overseerr_mcp/client.py`: Overseerr HTTP client (uses `httpx`)
- `docs/overseerr-api.yaml`: upstream Overseerr API contract
- `skills/overseerr/SKILL.md`: Claude skill invocation docs
