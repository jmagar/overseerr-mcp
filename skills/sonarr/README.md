...
→ Check your `.env` file exists at `~/.config/overseerr-mcp/.env` and contains SONARR_URL and SONARR_API_KEY
...
- Uses Sonarr API v3
- Credentials loaded from `~/.config/overseerr-mcp/.env` (NO JSON config files)
